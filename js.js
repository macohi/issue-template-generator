...
window.onbeforeunload = function (event) {
	if (!submitButtonClicked) {
		...
		return (event.returnValue =
			"Do you really want to leave this page? All progress will get lost.");
	}
};
...
function checkParams() {
	...
	return (
		typeof urlParams.get("Name") !== "undefined" &&
		typeof urlParams.get("Description") !== "undefined"
	);
}

document.addEventListener("DOMContentLoaded", function () {
	// Sets placeholders
	document.getElementsByName("dropdown_Options")[0].placeholder =
		"- Option 1\n- Option 2";
...
function add_textfield() {
	...
	var Description = document.getElementsByName(
		"textfield_Description",
	)[0];
	var Value = document.getElementsByName("textfield_Value")[0];
	var Placeholder = document.getElementsByName(
